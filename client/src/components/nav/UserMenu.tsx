...
export default function UserMenu() {
  ...
  return (
    <>
      ...
      <Menu open={userMenuOpened} anchorEl={userMenu} onClose={() => setUserMenuOpened(false)} />
    </>
  );
}
      ...
      <MenuContent>
        {currentUser && (
          <div className="px-2 pb-2">
            <Typography noWrap className="text-sm font-semibold">
            ...
            {currentUser.team && (
              <div className="mt-2 flex items-center">
                ...
                <Typography noWrap className="ml-2 text-sm font-medium">
        ...
        <Button variant="outlined" color="inherit" className="text-danger" onClick={handleLogout}>
          Logout
        </Button>
      </MenuContent>
