...
export default function PrivacyPolicy() {
  return (
    <PrivacyContainer className="flex flex-col items-center p-8 text-gray-800">
      <h1>Privacy Policy</h1>
      <p className="pt-0 pb-8 text-center italic text-gray-600">(Last updated: June 10, 2021)</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Shape My Tasks.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Shape My Tasks, accessible from{' '}
            <a
              href="https://shapemytasks.com"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://shapemytasks.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          objects (or Flash Cookies) to collect and store information about Your preferences or Your
          activity on our Service. Flash Cookies are not managed by the same browser settings as
