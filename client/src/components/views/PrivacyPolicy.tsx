...
const PrivacyContainer = styled.div`
  ...
  h3 {
    ...
    ${tw`font-medium text-base text-center`}
  }
...
export default function PrivacyPolicy() {
  return (
    <PrivacyContainer className="p-8 text-gray-800 flex flex-col items-center">
      <h1>Privacy Policy</h1>
      <p className="text-center italic text-gray-600 pt-0 pb-8">(Last updated: June 10, 2021)</p>
      ...
      <p>
        ...
        {' '}
        <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noreferrer">Privacy Policy Generator</a>
        .
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            {' '}
            (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Shape My Tasks.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            {' '}
            refers to Shape My Tasks, accessible from
            {' '}
            <a href="https://shapemytasks.com" rel="external nofollow noopener noreferrer" target="_blank">https://shapemytasks.com</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        {' '}
        <a href="https://www.termsfeed.com/blog/cookies/" target="_blank" rel="noreferrer">All About Cookies by TermsFeed</a>
        .
      </p>
      ...
      <ul>
        <li>By email: amoore1337@gmail.com</li>
      </ul>
    </PrivacyContainer>
  );
}
