 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment CurrentUserFragment on CurrentUser {\n  id\n  email\n  name\n  avatarUrl\n  team {\n    id\n    name\n    joinCode\n  }\n}"): (typeof documents)["fragment CurrentUserFragment on CurrentUser {\n  id\n  email\n  name\n  avatarUrl\n  team {\n    id\n    name\n    joinCode\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  query CurrentUser {\n    currentUser {\n      ...CurrentUserFragment\n    }\n  }\n"): (typeof documents)["\n  query CurrentUser {\n    currentUser {\n      ...CurrentUserFragment\n    }\n  }\n"];
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment FlagFragment on Flag {\n  id\n  message\n  scopeId\n}"): (typeof documents)["fragment FlagFragment on Flag {\n  id\n  message\n  scopeId\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  mutation CreateFlag($scopeId: ID!, $message: String) {\n    createFlag(scopeId: $scopeId, message: $message) {\n      ...FlagFragment\n    }\n  }\n"): (typeof documents)["\n  mutation CreateFlag($scopeId: ID!, $message: String) {\n    createFlag(scopeId: $scopeId, message: $message) {\n      ...FlagFragment\n    }\n  }\n"];
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment ProjectFragment on Project {\n  id\n  title\n  description\n  visibility\n  createdAt\n  updatedAt\n}\n\nquery Projects {\n  projects {\n    ...ProjectFragment\n  }\n}"): (typeof documents)["fragment ProjectFragment on Project {\n  id\n  title\n  description\n  visibility\n  createdAt\n  updatedAt\n}\n\nquery Projects {\n  projects {\n    ...ProjectFragment\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  mutation CreateProject($title: String!, $description: String $visibility: String) {\n    createProject(title: $title, description: $description, visibility: $visibility) {\n      ...ProjectFragment\n    }\n  }\n"): (typeof documents)["\n  mutation CreateProject($title: String!, $description: String $visibility: String) {\n    createProject(title: $title, description: $description, visibility: $visibility) {\n      ...ProjectFragment\n    }\n  }\n"];
